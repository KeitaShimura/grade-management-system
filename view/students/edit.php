...
<body>
    <h1 class="fs-1" style="margin: 50px 0 0 40px;">生徒更新画面</h1>
    <div style="text-align: center;" class="position-relative">
        <form method="POST" action="update.php">
            <input type="hidden" name="id" value="<?php print($student[0]); ?>">
            ...
            <div class="form" style="text-align: center;">
                <div class="mb-3">
                    ...
                    <input type="number" min="1" max="10" class="form-control" id="year" name="year" value="<?php print($student[1]); ?>">
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">クラス</label>
                    <input type="number" min="1" max="10" class="form-control" id="class" name="class" value="<?php print($student[2]); ?>">
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">学生番号</label>
                    <input type="number" min="1" max="100" class="form-control" id="number" name="number" value="<?php print($student[3]); ?>">
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">お名前</label>
                    <input type="text" class="form-control" name="name" value="<?php print($student[4]); ?>">
                </div>
        ...
        <form method="POST" action="delete.php?id=<?php print($student['id']); ?>">
